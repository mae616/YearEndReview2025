...
<!--
タイトルスライドです。
「ゆるっと2025年の振り返りLT会！」というイベントで登壇します。

このLTの目的（WHY）は、2025年を振り返り、挑戦と挫折、そして少しずつの成長の過程を共有することです。
特に、「外部のイベント」から「自分発信の行動」へと変化していった一年の軌跡を伝えたいと思っています。

聞き手には、同じように挑戦して失敗したり、落ち込んだりしながらも、少しずつ前に進んでいる人の姿を見てもらいたいです。
-->
...
<!--
mae616（まえ）といいます。
エンジニア歴8年のWebエンジニアで、普段は小さなコミュニティの運営などをしています。

現在は1.5年程前に離職し、フリーランスの準備中になります。
この一年は、その準備期間でもあり、様々な挑戦と失敗を繰り返しながら、少しずつ自分らしい働き方や活動の形を見つけていった一年でした。

このスライドで、聞き手に自分がどんな立場にいるのかを伝え、その後の話の文脈を理解してもらうためのものです。
-->
...
<!--
今日は、2025年を3つの時期に分けて振り返ります。

この構成にした理由は、時系列の羅列ではなく、それぞれの時期の特徴と変化を明確に伝えるためです。
前半は勢いで挑戦して折れ続けた時期、中盤はコミュニティと活動が広がった時期、後半は少しずつ成長した時期です。

それぞれの時期で何が起こり、どう変化していったかを話していきます。
聞き手には、この3つの時期の流れを頭に入れてもらい、その後の話を理解しやすくするためのスライドです。
-->
...
<div class="text-xl mt-4 font-bold text-gray-800">
勢いで挑戦して折れ続けた時期
</div>
...
<div class="flex items-start gap-4 p-3 bg-blue-50 rounded-lg">
  <div class="font-bold text-blue-600 min-w-[90px] text-sm">2024年12月</div>
  <div class="text-gray-800 text-sm">
    <div class="font-semibold">アドベントカレンダー初挑戦</div>
    <div class="text-gray-600 text-xs mt-1">参加しすぎて頭が回らなくなる</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-red-50 rounded-lg">
  <div class="font-bold text-red-600 min-w-[90px] text-sm">2024年12月</div>
  <div class="text-gray-800 text-sm">
    <div>初プロポーザル提出 → <span class="font-bold text-red-600">落選</span></div>
    <div class="text-gray-600 text-xs mt-1">しばらくうじうじする</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
  <div class="font-bold text-gray-600 min-w-[90px] text-sm">2025年1月</div>
  <div class="text-gray-800 text-sm font-semibold">Cursorを使い始める</div>
</div>

<div class="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
  <div class="font-bold text-gray-600 min-w-[90px] text-sm">2025年2月</div>
  <div class="text-gray-800 text-sm">
    <div class="font-semibold">Zennハッカソン チーム参加</div>
    <div class="text-gray-600 text-xs mt-1">2回目のハッカソン</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
  <div class="font-bold text-gray-600 min-w-[90px] text-sm">2025年3月</div>
  <div class="text-gray-800 text-sm font-semibold">有料ITエンジニアコミュニティを退会</div>
</div>

</div>

<!--
2024年12月にアドベントカレンダーに初挑戦しましたが、参加しすぎて頭が回らなくなりました。
ひとりアドベントカレンダーもやってみたが、他の記事に精一杯で中断しています。
...
2025年2月にZennハッカソンにチーム参加しました。
知り合いの方がX(Twitter)で一緒に参加する人を募集していたので、「やりたい」とコメントし、参加しました。
2回目のハッカソン参加になります。外部のイベントがきっかけで動いた典型例です。
...
<div class="flex items-start gap-4 p-3 bg-green-50 rounded-lg">
  <div class="font-bold text-green-600 min-w-[90px] text-sm">2025年4月</div>
  <div class="text-gray-800 text-sm">
    <div>AIイラスト・AI音楽が趣味に</div>
    <div class="font-bold mt-2 text-green-700">「ゆるっと もくもく会 for Women」を始める</div>
    <div class="text-gray-600 text-xs mt-1">初めて自分でコミュニティ運営</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-yellow-50 rounded-lg">
  <div class="font-bold text-yellow-600 min-w-[90px] text-sm">2025年5月</div>
  <div class="text-gray-800 text-sm">
    <div class="font-semibold">WAKE Careerさんハッカソン 初の個人参加</div>
    <div class="text-gray-600 text-xs mt-1">作りきれず</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-green-50 rounded-lg">
  <div class="font-bold text-green-600 min-w-[90px] text-sm">2025年6月</div>
  <div class="text-gray-800 text-sm space-y-1">
    <div>技術書典18 個人サークル初出展</div>
    <div class="font-bold text-green-700">「おだいで.dev」を始める</div>
    <div class="text-gray-600 text-xs">AIイラスト・AI音楽の活動が広がる</div>
  </div>
</div>
...
<!--
2025年4月に「ゆるっと もくもく会 for Women」を始めました。
初めて自分でコミュニティを作り運営を始めました。
これは、外部のイベントに参加するだけではなく、自分から何かを始めるという大きな変化です。
「ハッカソンの小さい版のコミュニティとかあったら面白いかな」という思いから始めました。

2025年5月にWAKE Careerさんハッカソンに初の個人参加しました。
チーム開発だと開発量を調節していたのでいつも作り終わっていたのですが、自分自身が一人でやった時どこまでできるのだろうとやったら普通に作りきれませんでした。
ただ、初めて体験することも多く勉強になりました。
この経験は、チーム開発と個人開発の違いを実感する重要な学びになりました。
...
<!--
この時期の学びは、チーム開発と個人開発の違いを実感したこと。
個人だと作りきれないということを実感しました。
これは、WAKE Careerさんハッカソンでの個人参加の経験から得た学びです。
...
<div class="flex items-start gap-4 p-3 bg-purple-50 rounded-lg">
  <div class="font-bold text-purple-600 min-w-[90px] text-sm">2025年9月</div>
  <div class="text-gray-800 text-sm">
    <div>OSS公開（Feedback only）</div>
    <div class="font-bold mt-2 text-green-600">初めてプロポーザルが採択される（3回目）</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-purple-50 rounded-lg">
  <div class="font-bold text-purple-600 min-w-[90px] text-sm">2025年10月</div>
  <div class="text-gray-800 text-sm">
    <div class="font-bold">Claude Code Meetup TokyoでLT登壇</div>
    <div class="text-gray-600 text-xs mt-1">技書博に東葛.devの合作本に寄稿</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-purple-50 rounded-lg">
  <div class="font-bold text-purple-600 min-w-[90px] text-sm">2025年11月</div>
  <div class="text-gray-800 text-sm space-y-1">
    <div>技術書典19（2回目の出展）</div>
    <div>プロポーザルに再び落選 → <span class="font-bold text-purple-700">でも分析して次を考えるようになった</span></div>
    <div class="text-gray-600 text-xs">「おだいで.dev」サンプルアプリから始める方針に変更</div>
  </div>
</div>

<div class="flex items-start gap-4 p-3 bg-purple-50 rounded-lg">
  <div class="font-bold text-purple-600 min-w-[90px] text-sm">2025年12月</div>
  <div class="text-gray-800 text-sm font-semibold">Advent of Code、アドベントカレンダー</div>
</div>
...
技書博に東葛.devの合作本に参加しました。
初めて寄稿に参加しました。上記のClaude Code Meetup Tokyoの元となった原稿で2寄稿させていただきました。

2025年11月に技術書典19に2回目の出展です。
ページ見切りが発生。コストが倍になって、きちんと損益をしないと厳しくなりました。
これは、活動を継続していく上での現実的な課題として学びました。
...
これは、完璧主義から脱却し、小さく始めることの大切さを学んだ出来事です。
...
「おだいで.dev」の開発方針を変更したことで、完璧主義から脱却し、小さく始めることの大切さを学びました。
...
<!--
このスライドは、一年を通しての変化をまとめる重要なスライドです。

今年一年は、前半は「外部のイベント」がきっかけで動いていることが多い時期でした。
でも後半からは、「自分がやりたいからやる」という内部の動機をきっかけに、アプリ開発やもくもく会の運営など、自分発信の行動が増えるようにしていきました。
これは、このLTで伝えたい最も重要な変化の一つです。

メンタル面は、まだ疲れてしまうと落ち込むこともあります。
でも、少しずつ前よりは戻ってこられるようになってきました。
AIイラスト・AI音楽が趣味になったことや、コミュニティ運営など、自分が楽しめる活動が増えたことが、この回復につながっています。

聞き手には、この一年で自分がどう変わったのか、特に「外部のイベント」から「自分発信の行動」への変化を実感してもらいます。
-->
...
<!--
来年も技術同人誌を継続して出していきたいです。
技術書典18、19と2回出展して、その楽しさや難しさを実感しました。
継続していくことで、さらに成長していきたいと思っています。

また、今年ハッカソンやコミュニティで得た学びを活かして、小さくても自分らしい個人開発プロダクトを形にしていきたいと思っています。
「おだいで.dev」のサンプルアプリから始める方針に変更したように、完璧主義を捨て、小さく始めて成長を見ていく姿勢を大切にしていきます。

このスライドで、来年への展望を示します。
聞き手には、この一年の学びを活かして、さらに前に進んでいく姿勢を伝えます。
-->
...
2025年は、挑戦して落ち込んで、でも少しずつ成長できた一年でした。
特に、「外部のイベント」から「自分発信の行動」への変化と、失敗の受け止め方が変わったことが、大きな成長だったと思います。

来年も、自分らしく、小さくても形にしていきたいと思います。
同じように挑戦して失敗したり、落ち込んだりしている人にも、少しずつ前に進んでいけることを伝えられたら嬉しいです。

このスライドで、LTを締めくくります。
聞き手に、この一年の振り返りと、来年への展望を伝え、前向きな気持ちで終われるようにします。
-->
